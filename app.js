...
// var students = ["Ghous","Anas","Owais","Ahsan"]
...
// student.pop() remove end value at the end

// student.push("Bilal","Anas") push value to end 


// student.shift() remove element from start
// student.unshift("Bilal","Anas") add elememt at start


// var student = ["ghos","anas","owais","ahsan"]

// // student.splice(1,1)
// student.shift()
// var copyStudents = student.slice(1,3)
// console.log(student)
...
//     alert("enter your  NIC")
// }
// else if (age >= 18 && age <= 40) {
//     alert("apply first time?")
// }
...
//  Task Two
// var b = "Welcome to js land Happy Coding";
// alert(b)

// Task three
// let a = "Hello...I can run js through my web Bowser's console";
// alert (a)


// TASK THREE

// var x = "Enter Your name";
// var y = "Hello World "
// var a = prompt(x,y,name);
// var b = a + name;
...
// let x = "My email is example@example.com"
// let b = a ;
// let a = +prompt(x,y,);
// document.write("The Output is" + " "+b)
// alert(x)

// var x = "My email is example@example.com";
// var y = "Hello World "
// var a = prompt(x,y);
// var b = a ;
// alert("Email Verified" + " "+b)
...
// var x = "Enter Visitor's name";
// var b = "Visitor's name is...."
// var y = " Quantity i.e. how many products a visitor wants to order"
// var a = prompt(x,b)
// var c = a ;
// document.write( +" "+c)
...
// var text = "The first string inside the parentheses is the segment to be replaced. The second World War II "
...
// IS SEY KISI BHI WORD KE VALUE DAY KR OS KA ALPHABAD MALOOM KEYA JA SKTA HA 
// var a = "Ghous"
// console.log(a.charAt(2))

// OR YA REPLACE KR DATA HAIN KISI BHI WORD KO

// var para = "This is Example"
// para.replace(Example, Text)
...
//         alert(arr[i] + " " + lastName [j])
//     }
// }

// var items = ["biryani", "burger", "chawal", "cake"];
...
// var dayNames = ["Sun", "Mon", "Tue","Wed","Thus","Fri","Sat","Sun"];
// var now = new Date();
...
// function greet(neme,greetText="It is a default value"){
//     console.log(neme + " is a good boy");
//     console.log(greetText + " " + neme);
// }
